...
export const validateCreateStoreAdmin = (req: Request, res: Response, next: NextFunction) => {
...
export const validateUpdateStoreAdmin = (req: Request, res: Response, next: NextFunction) => {
  const { name, email, password } = req.body;
